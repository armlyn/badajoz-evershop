...
class RegionCollection {
    ...
    async init(filters = [], isAdmin = false) {
        ...
        // Apply the filters
        const regionCollectionFilters = await getValue(
            'regionCollectionFilters',
            [],
            {
                isAdmin
            }
        ...
        regionCollectionFilters.forEach((filter) => {
...
module.exports.RegionCollection = RegionCollection;
